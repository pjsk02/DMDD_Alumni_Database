...
public class EducationJPanel extends javax.swing.JPanel {
     ...
     */
    JPanel container;
    public EducationJPanel(JPanel c) {
        initComponents();
        this.container = c;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 840, 270));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 410, -1, 50));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 410, 110, 50));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            while (rs.next()) {
                ...
                String eid = String.valueOf(rs.getInt("EducationID"));
                String sid = String.valueOf(rs.getInt("StudentID"));
                String iname = rs.getString("Institution");
                String degree = rs.getString("Degree");
                String spec = rs.getString("Specialization");
                String strt_year = rs.getString("StartingYear");
                String pass_year = rs.getString("PassingYear");
                String gpa = String.valueOf(rs.getFloat("GPA"));

                // Create a row of data
                String tbData[] = {eid, sid, iname, degree, spec, strt_year, pass_year, gpa};
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            String eduID = (String) jTable1.getValueAt(selectedRow, 0); // Assuming StudentID is in the first column
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                String sql = "DELETE FROM Education WHERE EducationID = ?"; // Assuming StudentID is the primary key

                // Prepare the statement
                PreparedStatement pstmt = conn.prepareStatement(sql);
                pstmt.setString(1, eduID); // Set the StudentID to delete
